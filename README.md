> [!NOTE]
> This repository builds `wmbusmeters` from the `zapster/wmbusmeters:fix-amiplus-total-energy-consumption` branch.
> The branch now tracks upstream 3.0.0 — no code patches are applied.
